...
<li class="comment-item">
    <div class="comment-item-meta">
        ...
        ?>
        <span class="comment-item-time"><?php wpmx_icon('comments-fill'); echo esc_html($human_time);?></span> <span><?php printf(__('On <a target="_blank" href="%1$s">%2$s</a>', 'wpcom'), get_permalink($comment->comment_post_ID), get_the_title($comment->comment_post_ID) ); ?></span>
    </div>
