...
class WPCOM_ADMIN_UTILS_FREE{
    ...
    public static function panel_script(){
        // Load CSS
        wp_enqueue_style( "mobx-panel", WPCOM_ADMIN_FREE_URI . "css/panel.css", false, WPCOM_ADMIN_FREE_VERSION, "all");
        wp_enqueue_style( 'wp-color-picker' );

        // Load JS
        wp_enqueue_script("mobx-panel", WPCOM_ADMIN_FREE_URI . "js/panel.js", array('jquery', 'jquery-ui-core', 'wp-color-picker'), WPCOM_ADMIN_FREE_VERSION, true);
        wp_enqueue_media();
    }
